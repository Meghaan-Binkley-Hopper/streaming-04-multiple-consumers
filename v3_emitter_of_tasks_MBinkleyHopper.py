"""
    This program reads a CSV file and sends as a message to a queue on the RabbitMQ server.
...
def send_message(host: str, queue_name: str, message: str):
    ...
    try:
        ...
        ch.queue_declare(queue='meghaan_queue', durable=True)
        # use the channel to publish a message to the queue
        # every message passes through an exchange
        ch.basic_publish(exchange="", routing_key='meghaan_queue', body=message)
...
if __name__ == "__main__":  
    ...
    send_message("localhost","meghaan_queue",message)